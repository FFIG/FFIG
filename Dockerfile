...
curl -s https://julialang-s3.julialang.org/bin/linux/x64/1.0/julia-1.0.1-linux-x86_64.tar.gz | tar zxf - -C /opt;\
ENV PATH=/opt/julia-1.0.1/bin/julia:/opt/swift-4.1-RELEASE-ubuntu16.10/usr/bin:"$PATH"
