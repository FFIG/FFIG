...
RUN pip install --upgrade pip && pip install jinja2 clang jupyter notebook asciitree nose
RUN gem install ffi
...
USER c-api-user
RUN git clone --recurse-submodules https://github.com/jbcoe/ffig /home/c-api-user/demo
